...
def optimizemodel_sc(train_set2,labels_train_set2,test_set2,labels_test_set2,modelname,classes,testing_set,min_num,selectedfeature,training_data):
    ...
    maxacc=max([c2,c3,c4,c6,c7,c8,c9,c10,c11])
    ...
    modeltypes=['decision-tree','gaussian-nb','sk','adaboost','gradient boosting','logistic regression','hard voting','knn','random forest']
    accuracym=[c2,c3,c4,c6,c7,c8,c9,c10,c11]
    accuracys=[c2s,c3s,c4s,c6s,c7s,c8s,c9s,c10s,c11s]
    model_accuracy=list()
